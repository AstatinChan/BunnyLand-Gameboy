...
print("\n\t; Bush Medium")
get_sprite_png_parse_output("./sprites/bg/bush-medium.png", sprite_8x8=True)
print("\n\t; Flower")
get_sprite_png_parse_output("./sprites/bg/flower.png", sprite_8x8=True)
print("\n\t; Bush Small")
get_sprite_png_parse_output("./sprites/bg/bush-small.png", sprite_8x8=True)
print("\n\t; Grass")
